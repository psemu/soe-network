...
var resourceEventDataSubSchema = [
    ...
    { name: "unknownData2",         type: "schema", fields: [
        { name: "maxValue",             type: "uint32" },
        { name: "initialValue",         type: "uint32" },
        { name: "unknownFloat1",        type: "float" },
        { name: "unknownFloat2",        type: "float" },
...
var achievementObjectiveDataSchema = [
...
var characterAchievementDataSchema = [
    { name: "achievementId",        type: "uint32" },
    { name: "nameId",               type: "uint32" },
    { name: "descriptionId",        type: "uint32" },
    { name: "unknownBoolean1",      type: "boolean" },
    ...
    { name: "objectives",           type: "array", fields: [
        ...
        { name: "data",                 type: "schema", fields: achievementObjectiveDataSchema }
    ]},
...
var packets = [
    ...
    ["SendSelfToClient",                                0x03, {
        fields: [
            { name: "data",                 type: "byteswithlength", fields: [
                ...
                { name: "characterAchievements",    type: "array", fields: characterAchievementDataSchema},
    ...
    ["PlayerUpdate.AddLightweightNpc",                  0x0F52, {
        fields: [
            { name: "guid",             type: "uint64" },
            { name: "unknownUint1",     type: "custom", parser: readUnsignedIntWith2bitLengthValue, packer: packUnsignedIntWith2bitLengthValue },
            { name: "unknownString0",   type: "string" },
            { name: "nameId",           type: "uint32" },
            { name: "unknownDword2",    type: "uint32" },
            { name: "unknownDword3",    type: "uint32" },
            { name: "unknownByte1",     type: "uint8" },
    ...
    ["ClientUpdate.ZonePopulation",                     0x112100, {
        fields: [
            { name: "populations",       type: "array",     elementType: "uint8" }
        ]
    }],
    ["ClientUpdate.RespawnLocations",                   0x112200, {
        fields: [
            ...
            { name: "locations",                type: "array",     
                fields: [
                    ...
                    { name: "unknownDword3",        type: "uint32" },
                    { name: "unknownByte8",         type: "uint8" },
                    { name: "unknownByte9",         type: "uint8" }
                ]
            }
        ]
    }],
    ...
    ["LobbyGameDefinition.LobbyGameUnknown1",                      0x4201, {
        fields: [
            { name: "unknown1",        type: "uint8" }
        ]
    }],
    ["LobbyGameDefinition..LobbyGameUnknown2",                      0x4202, {}],
    ...
    ["Achievement.Add",                                     0x6602, {
        fields: [
            { name: "achievementId",        type: "uint32" },
            { name: "achievementData",      type: "schema", fields: achievementObjectiveDataSchema }
        ]
    }],
    ["Achievement.Initialize",                              0x6603, {
        fields: [
            // { name: "achievements",         type: "array", fields: [
            //     { name: "unknown1",        type: "uint32" },
            //     { name: "unknown2",        type: "uint32" },
            //     { name: "unknown3",        type: "uint32" },
            //     { name: "unknown4",        type: "uint8" },
            ...
            //     { name: "unknown8",        type: "float" },
            //     { name: "unknown9",        type: "float" },
            //     { name: "unknown10",        type: "array", fields: [
    ...
    ["Mount.MountList",                                   0x7305, {}],
    ["Mount.MountSpawn",                                  0x7306, {}],
    ["Mount.MountDespawn",                                0x7307, {}],
    ["Mount.MountSpawnByItemDefinitionId",                0x7308, {}],
    ["Mount.MountOfferUpsell",                            0x7309, {}],
    ["Mount.SeatChangeRequest",                           0x730A, {}],
    ["Mount.SeatChangeResponse",                          0x730B, {}],
    ["Mount.SeatSwapRequest",                             0x730C, {}],
    ["Mount.SeatSwapResponse",                            0x730D, {}],
    ["Mount.MountPacketTypeCount",                        0x730E, {}],
